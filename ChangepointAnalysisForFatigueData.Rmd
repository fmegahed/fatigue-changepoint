...
'. Fourth, the <b> <font color=#FFA500> orange lines  are used to denote the univariate, nonparametric changepoints obtained from applying the e.divisive() on the CUSUM of the RPE values. </font> </b> \n \n'))
    ...
    cat(paste0('<source> <p> Based on the <b>ecp package, the number of changepoints for the First PC of the median filtered data for participant ', i,
             ' is equal to: ',
...
## Plots with the Median Filtered Data and their Changepoints {.tabset .tabset-fade}

...
Here, we apply the ecp approach of Matterson and James (2014) on the **median filtered differenced data** (as opposed to the median filtered timeseries). For demonstration purpose, we use $m_{ecp} = 120$ below.  

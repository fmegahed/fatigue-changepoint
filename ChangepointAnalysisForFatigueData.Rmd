...
Here, we apply the ecp approach of Matterson and James (2014) on the **cusums of the median filtered data** (as opposed to the median filtered timeseries). For demonstration purpose, we use $m_{ecp} = 180$ below. 
...
# Things to Do Next
  ...
  (C) See if the insights from the ECP package are consistent with the approach of Giovanna and Guido.  

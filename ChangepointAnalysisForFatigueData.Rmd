...
The data post the median filtered approach is stored at the [following location](https://github.com/fmegahed/fatigue-changepoint/blob/master/Data/RGenerated/MedianFilteredData.RData?) in our GitHub Repository.
...
## The Nonparameteric Approach of Matterson and James for Multiple Changepoint Detection 
...
```
The results from the analysis above can be found at: [ECPChangePointsMFData.RData](https://github.com/fmegahed/fatigue-changepoint/blob/master/Data/RGenerated/ECPChangePointsMFData.RData)
...
```
The results from the analysis above can be found at: [ECPChangePointsDiffMFData.RData](https://github.com/fmegahed/fatigue-changepoint/blob/master/Data/RGenerated/ECPChangePointsDiffMFData.RData)

...
author:
  ...
  - Fadel M. Megahed^[Farmer School of Business, Miami University]
institute: 
  ...
  - $^3$ Farmer School of Business, Miami University of Ohio
...
cat('<source> <p>
We could have tried making the value of the coefficient multiplied by the IQR coefficient smaller; however, we did not explore this option since this: (a) would have possibly required a large amount of trial-and-error, (b) the approach would be difficult to justify, and (c) we thought it would be more efficient to examine multivariate and/or time-series outlier detection methods next. </p> </source>')

...
(B) A threshold based comparison, where we use $\small RPE=13$ to identify when a participant becomes fatigued and we compare that to the changepoints detected by the hybrid CUSUM-EPC approach; and 
...
```{r RPE_Analysis, cache=TRUE, fig.align='center', results='asis', out.width='65%', message=FALSE}
